...
class VideoCooker:
    """
    A class to extract frames from videos based on scene changes.
    """

    def __init__(self, video_dir="raw_video", output_dir="output_images", similarity_threshold=0.3):
        """
        Initializes the VideoCooker class.

        Args:
            video_dir (str): Directory containing the video files.
            output_dir (str): Directory to save the extracted frames.
            similarity_threshold (float): Threshold for detecting scene changes.
        """
    ...
    def extract_frames(self):
        """
        Extracts frames from videos in the specified directory based on scene changes.
        """
